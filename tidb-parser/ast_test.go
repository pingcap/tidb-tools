...
func (s *testFilterSuite) TestResolveDDLSQL(c *C) {
	s.testNonDDL(c)
	s.testComments(c)
...
func (s *testFilterSuite) testNonDDL(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testComments(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testDropTable(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testFailedCases(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testCreateIndex(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testAlterTableOption(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testAlterTableAddColumn(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testAlterTableDropColumn(c *C) {
...
func (s *testFilterSuite) testAlterTableDropIndex(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testAlterTableAddConstraint(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testAlterTableDropForeignKey(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testAlterTableModifyColumn(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testAlterTableChangeColumn(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testAlterTableRenameTable(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testAlterTableAlterColumn(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testAlterTableDropPrimaryKey(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testAlterTableLock(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) testAlterTableConvert(c *C) {
	tests := []testCase{
...
func (s *testFilterSuite) run(c *C, tests []testCase) {
