...
* M_1 设置 arguments = [1, "s_", "t_"], 那么表 `s_1`.`t_1` 的 `ID = 1` 的列经过转换后 ID 变为 `1 | 1 << (64-1-4) | 1 << (64-1-4-7) | 1 << 44 = 580981944116838401`
* M_2 设置 arguments = [2, "s_", "t_"], 那么表 `s_1`.`t_2` 的 `ID = 1` 的行经过转换后 ID 变为 `2 | 1 << (64-1-4) | 1 << (64-1-4-7) | 2 << 44 = 1157460288606306305`