...
check_contains "\`router_test_0\`.\`tbl\`" $OUT_DIR/sync_diff.log
check_contains "\`Router_test_0\`.\`tbl\`" $OUT_DIR/sync_diff.log
check_contains "\`router_test_0\`.\`Tbl\`" $OUT_DIR/sync_diff.log
#check_not_contains "\`router_test_1\`.\`tbl\`" $OUT_DIR/sync_diff.log
check_contains_count "\`router_test_1\`.\`tbl\`" $OUT_DIR/sync_diff.log 1
check_not_contains "\`Router_test_1\`.\`tbl\`" $OUT_DIR/sync_diff.log
check_not_contains "\`router_test_1\`.\`Tbl\`" $OUT_DIR/sync_diff.log
check_not_contains "\`Router_test_1\`.\`Tbl\`" $OUT_DIR/sync_diff.log
rm -rf $OUT_DIR/*
...
check_contains "\`router_test_0\`.\`tbl\`" $OUT_DIR/sync_diff.log
check_contains "\`Router_test_0\`.\`tbl\`" $OUT_DIR/sync_diff.log
check_not_contains "\`router_test_0\`.\`Tbl\`" $OUT_DIR/sync_diff.log
#check_not_contains "\`router_test_1\`.\`tbl\`" $OUT_DIR/sync_diff.log
check_contains_count "\`router_test_1\`.\`tbl\`" $OUT_DIR/sync_diff.log 1
check_not_contains "\`Router_test_1\`.\`tbl\`" $OUT_DIR/sync_diff.log
check_not_contains "\`router_test_1\`.\`Tbl\`" $OUT_DIR/sync_diff.log
...
check_not_contains "\`Router_test_0\`.\`tbl\`" $OUT_DIR/sync_diff.log
check_not_contains "\`router_test_0\`.\`Tbl\`" $OUT_DIR/sync_diff.log
#check_contains "\`router_test_1\`.\`tbl\`" $OUT_DIR/sync_diff.log
check_contains_count "\`router_test_1\`.\`tbl\`" $OUT_DIR/sync_diff.log 2
check_contains "\`Router_test_1\`.\`tbl\`" $OUT_DIR/sync_diff.log
check_contains "\`router_test_1\`.\`Tbl\`" $OUT_DIR/sync_diff.log
check_contains "\`Router_test_1\`.\`Tbl\`" $OUT_DIR/sync_diff.log
rm -rf $OUT_DIR/*
