	...
	require.JSONEq(t, cfg.String(),
		`{
			...
			"task": {
				...
				"FixDir": "/tmp/output/config/fix-on-tidb0",
				"CheckpointDir": "/tmp/output/config/checkpoint",
				"HashFile": ""
			},
			"ConfigFile": "config_sharding.toml",
			"PrintVersion": false
		}`)
