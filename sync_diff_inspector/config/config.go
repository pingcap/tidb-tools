...
type TaskConfig struct {
	...
	// SyncpointChangefeed restricts snapshot = "auto" to the syncpoint row
	// generated by the configured TiCDC changefeed.
	SyncpointChangefeed string `toml:"syncpoint-changefeed" json:"syncpoint-changefeed"`
