...
func TestTiDBSource(t *testing.T) {
	...
	require.Equal(t, tidb.GenerateFixSQL(Insert, firstRow, secondRow, 0), "REPLACE INTO `source_test`.`test1`(`a`,`b`,`c`,`d`) VALUES (1,'a',1.2,x'aa');")
	require.Equal(t, tidb.GenerateFixSQL(Delete, firstRow, secondRow, 0), "DELETE FROM `source_test`.`test1` WHERE `a` = 2 AND `b` = 'b' AND `c` = 3.4 AND `d` = x'bb' LIMIT 1;")
	require.Equal(t, tidb.GenerateFixSQL(Replace, firstRow, secondRow, 0),
		"/*\n"+
			"  DIFF COLUMNS ╏ `A` ╏ `B` ╏ `C` ╏  `D`   \n"+
			"╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╋╍╍╍╍╍╋╍╍╍╍╍╋╍╍╍╍╍╋╍╍╍╍╍╍╍╍\n"+
			"  source data  ╏ 1   ╏ 'a' ╏ 1.2 ╏ x'aa'  \n"+
			"╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╋╍╍╍╍╍╋╍╍╍╍╍╋╍╍╍╍╍╋╍╍╍╍╍╍╍╍\n"+
			"  target data  ╏ 2   ╏ 'b' ╏ 3.4 ╏ x'aa'  \n"+
			"╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╋╍╍╍╍╍╋╍╍╍╍╍╋╍╍╍╍╍╋╍╍╍╍╍╍╍╍\n"+
			"*/\n"+
			"REPLACE INTO `source_test`.`test1`(`a`,`b`,`c`,`d`) VALUES (1,'a',1.2,x'aa');")
