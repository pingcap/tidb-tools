...
type Binlog struct {
	...
	UtcTimeZone      *string `protobuf:"bytes,5,opt,name=utc_time_zone,json=utcTimeZone" json:"utc_time_zone,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
func (m *Binlog) GetUtcTimeZone() string {
...
func (m *Binlog) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UtcTimeZone != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintBinlog(dAtA, i, uint64(len(*m.UtcTimeZone)))
		i += copy(dAtA[i:], *m.UtcTimeZone)
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
var fileDescriptorBinlog = []byte{
	...
	,
}
