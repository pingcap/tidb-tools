...
func (*Table) Descriptor() ([]byte, []int) {
	return fileDescriptor_07ff5a43190a1b8c, []int{3}
}
...
func (*Key) Descriptor() ([]byte, []int) {
	return fileDescriptor_07ff5a43190a1b8c, []int{4}
}
...
func (*TableMutation) Descriptor() ([]byte, []int) {
	return fileDescriptor_07ff5a43190a1b8c, []int{5}
}
...
func (*DMLData) Descriptor() ([]byte, []int) {
	return fileDescriptor_07ff5a43190a1b8c, []int{6}
}
...
func (*DDLData) Descriptor() ([]byte, []int) {
	return fileDescriptor_07ff5a43190a1b8c, []int{7}
}
...
func (*Binlog) Descriptor() ([]byte, []int) {
	return fileDescriptor_07ff5a43190a1b8c, []int{8}
}
...
var fileDescriptor_07ff5a43190a1b8c = []byte{
	...
	,
}
...
func (m *ColumnInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x20
	i++
	i = encodeVarintBinlog(dAtA, i, uint64(m.Flen))
	dAtA[i] = 0x28
	i++
	i = encodeVarintBinlog(dAtA, i, uint64(m.Decimal))
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
	return i, nil
...
func (m *Binlog) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TimeZone != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintBinlog(dAtA, i, uint64(len(*m.TimeZone)))
...
func (m *ColumnInfo) Size() (n int) {
	...
	n += 1 + l + sovBinlog(uint64(l))
	n += 2
	n += 1 + sovBinlog(uint64(m.Flen))
	n += 1 + sovBinlog(uint64(m.Decimal))
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	return n
